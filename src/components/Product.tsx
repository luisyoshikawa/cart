...
const Product = ({inCart, REDUCER_ACTIONS, dispatch, product}:PropsType): React.ReactElement => {
  ...
  <article  className='product'>
    ...
    <p>{new Intl.NumberFormat('pt-BR', {style:'currency', currency: 'BRL'}).format(product.price)}{itemInCart}</p>
